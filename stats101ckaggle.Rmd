...
```{r}
bigridge <- cv.glmnet(model.matrix(HTWins~., data=train), wins, alpha=0, family="binomial")
...
classify = randomForest(HTWins ~ VTcumRest + HTcumRest + VT.TS.fgm + VT.TS.fga + 
    ...
    VT.OS1.dreb + VT.OS1.fgm + VT.OS2.plmin + 
    VT.OS2.dreb + VT.OS3.plmin + 
    VT.OS3.dreb + VT.OS4.dreb + VT.pmxU, data = train)
